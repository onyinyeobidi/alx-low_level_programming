...
/**
 * print_type - A functin that prints the type of an ELF header
 * Parameters:
 * @e_type: A function parameter 1
 * @e_ident: A function parameter 2
 */
void print_type(unsigned int e_type, unsigned char *e_ident)
{
 ...
 * Parameters:
 * @e_entry: A function parameter 1
 * @e_ident: A functioon parameter 2
 */
void print_entry(unsigned long int e_entry, unsigned char *e_ident)
{
 ...
 *        Parameters:
 * @argc: A function parameter 1
 * @argv: A function parameter 2
 * Return: 0 on success.
